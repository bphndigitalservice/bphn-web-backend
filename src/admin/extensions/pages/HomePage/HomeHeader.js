        ...
        <StackCustom spacing={5}>
          <Typography as="h1" variant="alpha">
            {hasCreatedContentType
              ? formatMessage({
                  id: 'app.components.HomePage_.welcome.again',
                  defaultMessage: 'Welcome 👋',
                })
              : formatMessage({
                  id: 'app.components.HomePage_.welcome',
          ...
          <WordWrap textColor="neutral600" variant="epsilon">
            {hasCreatedContentType
              ? formatMessage({
                  id: 'app.components.HomePage_.welcomeBlock.content.again',
                  defaultMessage:
              ...
              : formatMessage({
                  id: 'app.components.HomePage_.welcomeBlock.content',
                  defaultMessage:
          ...
          {hasCreatedContentType ? (
            <Link isExternal href="https://strapi.io/blog">
              {formatMessage({
                id: 'app.components.HomePage_.button.blog',
            ...
            <Button size="L" onClick={onCreateCT} endIcon={<ArrowRight />}>
              {formatMessage({
                id: 'app.components.HomePage_.create',
